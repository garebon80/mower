...
public final class Field extends Grid implements PositionController {
	 ...
	 * The constructor.
	 * 
	 * @param horizontalSize The horizontal size of the field. It must be at least 1 long.
	 * @param verticalSize The vertical size of the field. It must be at least 1 long.
	 */
