...
import seat.code.mower.impl.DefaultMovementStrategy;

/**
 * 
 * @author grebon
 * 
 * The mower is the principal (and unique) moveable. It is composed by a position and an orientation.
 */
public class Mower extends Movable {
	 ...
	 * @param movementStrategy The movement strategy to apply.
	 */
	 ...
	 * 
	 * @param controller The field you want to link with the mower.
	 */
	 ...
	 * 
	 * @param controller The field you want to unlink from the mower.
	 */
	...
	public void changeMyPositionTo(Position target) {
		...
		/** Target must be a valid position and it must be free (no other mower this location)**/
