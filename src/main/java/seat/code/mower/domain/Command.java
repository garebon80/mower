...
public enum Command {
	 ...
	 * The constructor.
	 * 
	 * @param code The command code (from a configuration).
	 */
	 ...
	 * 
	 * @param code The command code from the configuration.
	 ...
	 * 
	 * @param mower The {@link Mower} you want to execute the command on.
