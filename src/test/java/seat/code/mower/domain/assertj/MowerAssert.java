...
public class MowerAssert extends AbstractAssert<MowerAssert, Mower> {
	 ...
	 * actual Mower.
	 * 
	 * @param actual the Mower we want to make assertions on.
	 */
	 ...
	 * 
	 * @param orientation the given orientation to compare the actual Mower's orientation to.
	 * @return this assertion object.
	 * @throws AssertionError if the actual Mower's orientation is not equal to the given one.
	 */
	 ...
	 * 
	 * @param position the given position to compare the actual Mower's position to.
	 * @return this assertion object.
	 * @throws AssertionError - if the actual Mower's position is not equal to the given one.
	 */
