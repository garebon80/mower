...
public class PositionAssert extends AbstractAssert<PositionAssert, Position> {
	 ...
	 * 
	 * @param x the given x to compare the actual Position's x to.
	 * @return this assertion object.
	 * @throws AssertionError if the actual Position's x is not equal to the given one.
	 */
	 ...
	 * 
	 * @param y the given y to compare the actual Position's y to.
	 * @return this assertion object.
	 * @throws AssertionError if the actual Position's y is not equal to the given one.
	 */
